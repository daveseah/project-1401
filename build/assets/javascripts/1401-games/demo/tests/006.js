...
///	- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	function m_Start() {
		...
		window.DBG_Out( "<b>VisualFactory HeartBeat Interface</b>" );
		window.DBG_Out( "<tt>game-main include: 1401-games/demo/tests/006</tt>" );
		window.DBG_Out( "For downstream extenders of VisualFactory" );
